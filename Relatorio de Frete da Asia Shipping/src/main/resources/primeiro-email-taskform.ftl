	...
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">in_cod_importacao</label>
                            		<div class="div_checkbox">
                              		${in_cod_importacao}
                            		</div>
                            		...
                            		<label for="name">in_venddor_cs</label>
                            		<div class="div_checkbox">
                              		${in_venddor_cs}
                            		</div>
                            		<label for="name">in_fatura</label>
                            		<div class="div_checkbox">
                              		${in_fatura}
                            		</div>
                            		<label for="name">in_dt_eta</label>
                            		<div class="div_checkbox">
                              		${in_dt_eta}
                            		</div>
                            		<label for="name">in_dt_vencimento</label>
                            		<div class="div_checkbox">
                              		${in_dt_vencimento}
                            		</div>
