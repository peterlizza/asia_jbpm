...
public class tbl_header implements java.io.Serializable
{
   ...
   private java.lang.Character flag_fatura;
   ...
   public java.lang.Character getFlag_fatura()
   {
      return this.flag_fatura;
   }

   public void setFlag_fatura(java.lang.Character flag_fatura)
   {
   ...
   public tbl_header(java.lang.Long id, java.lang.Integer chave_controle,
         ...
         java.lang.Character flag_fatura, java.lang.Integer dias_de_atraso,
         java.lang.String filial_operac, java.util.Date data_criacao,
         java.util.Date data_processamento, java.lang.Character status)
   {
      this.id = id;
      this.chave_controle = chave_controle;
      this.cd_empresa = cd_empresa;
